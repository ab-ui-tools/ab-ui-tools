...
} from 'ab-ui-library/components/Select/types';
...
import IconGb from 'ab-ui-library/components/SVGIcons/IconGb';
import IconChevronUp from 'ab-ui-library/components/SVGIcons/IconChevronUp';
import IconChevronDown from 'ab-ui-library/components/SVGIcons/IconChevronDown';
import IconChatMultiple from 'ab-ui-library/components/SVGIcons/IconChatMultiple';
import IconAm from 'ab-ui-library/components/SVGIcons/IconAm';
import {
  Button,
  Select as _Select,
...
const MultiSelectTemplate: StoryFn<TMultiSelectPropTypes> = args => {
  ...
  return (
    <div style={{ width: 250, height: '100vh', position: 'absolute', left: 500, top: 10 }} className="ddddd">
      <_MultiSelect
        {...args}
        isGrouped={true}
        isButtonSelect={true}
...
const NestedSelectTemplate = (args: any): JSX.Element => {
  ...
  return (
    <div style={{ width: 320, position: 'absolute', left: 300 }}>
      <_NestedSelect {...args} selected={selected} setSelectedValue={setSelected} initialSelectedFolderIds={[1, 2]} />
    </div>
  );
};
