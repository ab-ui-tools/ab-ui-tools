...
export const IconBuilding = ({
  ...
  >
    ...
    <g id="Iconography">
      <rect width="51344" height="12568" transform="translate(-19103 -1288)" fill="#F4F4F4" />
      <g id="B Icons">
        <g id="Building">
          <rect x="-19.5" y="-19.5" width="107" height="63" rx="4.5" stroke="#9747FF" strokeDasharray="10 5" />
