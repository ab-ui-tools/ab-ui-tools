...
export const FlagIceland = ({ size, className = '', onClick, refHandler, id, dataId }: ISVGIconProps): ReactElement => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_9419_1747)">
      <path
        d="M10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20Z"
        style={{ fill: '#F0F0F0' }}
      />
      <path
        d="M0.344482 12.6088C0.923076 14.7556 2.19827 16.6163 3.91304 17.9338V12.6088H0.344482Z"
        style={{ fill: '#0052B4' }}
      />
      <path
        d="M9.13037 19.962C9.41701 19.9867 9.70689 20.0001 9.99994 20.0001C14.6202 20.0001 18.5079 16.8664 19.6554 12.6088H9.13037V19.962Z"
        style={{ fill: '#0052B4' }}
      />
      <path
