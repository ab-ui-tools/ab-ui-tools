...
export const FlagMadeira = ({ size, className = '', onClick, refHandler, id, dataId }: ISVGIconProps): ReactElement => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_9419_190)">
      ...
      />
      <path
        d="M5.65219 0.992615C2.30723 2.61008 0 6.03543 0 10C0 13.9646 2.30723 17.3899 5.65219 19.0074V0.992615Z"
        style={{ fill: '#0052B4' }}
      />
      <path
      ...
      />
      <path
        d="M12.6087 9.56524H10.4347V7.3913H9.56518V9.56524H7.39124V10.4348H9.56518V12.6087H10.4347V10.4348H12.6087V9.56524Z"
        style={{ fill: '#F0F0F0' }}
      />
    </g>
    <defs>
      <clipPath id="clip0_9419_190">
