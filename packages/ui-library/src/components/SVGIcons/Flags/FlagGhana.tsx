...
export const FlagGhana = ({ size, className = '', onClick, refHandler, id, dataId }: ISVGIconProps): ReactElement => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_9419_1548)">
      <path
