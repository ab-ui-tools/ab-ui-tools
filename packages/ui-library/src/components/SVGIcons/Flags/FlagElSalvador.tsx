...
export const FlagElSalvador = ({
  ...
  >
    <g clipPath="url(#clip0_9419_1248)">
      <path
      ...
      <path
        ...
        style={{ fill: '#0052B4' }}
      />
      <path d="M7.99182 10.4348L10 6.95654L12.0082 10.4348H7.99182Z" style={{ fill: '#FFDA44' }} />
      <path d="M12.6087 11.5832L9.99995 12.8876L7.39124 11.5832V9.84412H12.6087V11.5832Z" style={{ fill: '#6DA544' }} />
      <path
