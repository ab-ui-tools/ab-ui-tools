...
export const FlagJamaica = ({ size, className = '', onClick, refHandler, id, dataId }: ISVGIconProps): ReactElement => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_9419_1877)">
      <path
      ...
      />
      <path
        d="M17.9329 16.0881C19.229 14.4019 20 12.2912 20 9.99999C20 7.70882 19.229 5.59808 17.9329 3.91187L11.8447 9.99999L17.9329 16.0881Z"
        style={{ fill: 'black' }}
      />
    </g>
    <defs>
      <clipPath id="clip0_9419_1877">
