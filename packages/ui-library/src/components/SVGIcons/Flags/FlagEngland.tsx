...
export const FlagEngland = ({ size, className = '', onClick, refHandler, id, dataId }: ISVGIconProps): ReactElement => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_9419_1256)">
      <path
