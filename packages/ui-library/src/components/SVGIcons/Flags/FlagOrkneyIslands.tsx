...
export const FlagOrkneyIslands = ({
  size,
  className = '',
  onClick,
  refHandler,
  ...
  >
    <g clipPath="url(#clip0_9419_870)">
      ...
      />
      <path
        d="M0.344482 12.6087C0.923076 14.7555 2.19831 16.6162 3.91304 17.9338V12.6087H0.344482Z"
        style={{ fill: '#D80027' }}
      />
      <path
      ...
      />
      <path
        d="M3.91304 2.06622C2.19831 3.3838 0.923076 5.24446 0.344482 7.3913H3.91304V2.06622Z"
        style={{ fill: '#D80027' }}
      />
      <path
...
export default FlagOrkneyIslands;
