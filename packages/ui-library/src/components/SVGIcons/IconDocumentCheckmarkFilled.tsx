...
export const IconDocumentCheckmarkFilled = ({
  size,
  type,
  className = '',
  onClick,
  ...
  >
    <path
      ...
      fill="#222222"
    />
    <path d="M13.5 2.5V8C13.5 8.27614 13.7239 8.5 14 8.5H19.5L13.5 2.5Z" fill="#222222" />
    <path
...
export default IconDocumentCheckmarkFilled;
