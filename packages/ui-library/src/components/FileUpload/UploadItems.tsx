        ...
        return (
          <div
            className={`upload-item mt-4 ${
              filesErrors && Array.isArray(errors?.files) && errors.files[index]?.message ? 'upload-item--error' : ''
            }`}
            key={index}
          >
            <div className="upload-item__inner">
              <div className="upload-item__content">
                <div className="upload-item__content__inner pr-8">
                  ...
                  {filesErrors && (
                    <ErrorMessage message={Array.isArray(errors?.files) ? errors.files[index]?.message : ''} />
                  )}
                </div>
                <Button
                  type="tertiary"
