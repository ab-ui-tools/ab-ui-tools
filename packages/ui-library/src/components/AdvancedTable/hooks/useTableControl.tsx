...
import type { Column, ColumnSettings, ICellProps, IHeaderProps, SortingUpdateEvent, TTableProps } from '../types';
...
export function useTableControl<TData>({
  ...
  const activeHeader = activeId ? table.getHeaderGroups()[0].headers.find(header => header.id === activeId) : null;
